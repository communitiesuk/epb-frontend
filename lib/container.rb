...
class Container
  def initialize
    ...
    energy_assessments_gateway = Gateway::EnergyAssessmentsGateway.new(internal_api_client)
    fetch_assessment_use_case = UseCase::FetchAssessment.new(energy_assessments_gateway)
