...
deploy-app: ## Deploys the app to PaaS
	...
	cf set-env "${DEPLOY_APPNAME}" SUPPRESS_REDIRECT_TO_SERVICE_START "${SUPPRESS_REDIRECT_TO_SERVICE_START}"
	cf set-env "${DEPLOY_APPNAME}" SUPPRESS_REQUEST_THROTTLING "${SUPPRESS_REQUEST_THROTTLING}"
