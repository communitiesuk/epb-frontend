...
deploy-app: ## Deploys the app to PaaS
	...
	cf set-env "${DEPLOY_APPNAME}" GA_PROPERTY_FINDING "${GA_PROPERTY_FINDING}"
	cf set-env "${DEPLOY_APPNAME}" GA_PROPERTY_GETTING "${GA_PROPERTY_GETTING}"
	...
	cf set-env "${DEPLOY_APPNAME}" STATIC_START_PAGE_FINDING "${STATIC_START_PAGE_FINDING}"
	cf set-env "${DEPLOY_APPNAME}" STATIC_START_PAGE_GETTING "${STATIC_START_PAGE_GETTING}"
