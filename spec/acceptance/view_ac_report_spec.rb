...
describe "Acceptance::AirConditioningInspectionReport", type: :feature do
  ...
  describe "CEPC 6.0 AC report" do
    ...
    it "Explains that the detailed notes are not available" do
      expect(response.body).to have_css "p",
                                        text:
                                          "The detailed inspection notes from this report are no longer available online. If you require the detailed inspection notes, contact us at dluhc.digital-services@levellingup.gov.uk"
    end
  end
