...
module FetchAssessmentSummary
  class AssessmentStub
    ...
    def self.fetch_rdsap(
      ...
      current_space_heating_demand: 222,
      current_water_heating_demand: 321,
      ...
      if assessment_id == "1111-1111-1111-1111-1112"
        body = {
          "data": {
            ...
            estimatedEnergyCost: estimated_energy_cost,
            potentialEnergySaving: potential_energy_saving,
            "heatDemand": {
        ...
        body = {
          data: {
            ...
            hotWaterCostCurrent: hot_water_cost_current,
            hotWaterCostPotential: "100",
            lightingCostCurrent: "75",
            lightingCostPotential: "75",
            heatDemand: {
              currentSpaceHeatingDemand: current_space_heating_demand,
              currentWaterHeatingDemand: current_water_heating_demand,
